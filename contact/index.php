...
<head>
<meta charset="utf-8" />
<title>Contact :: Design 17 HTML5 Template</title>
<meta name="description" content="Photo Gallery HTML5 Website Template - By Flash-Gallery.Net contact" />
<meta name="robots" content="index, follow" />
<link rel="canonical" href="design17.flash-gallery.net/contact/" />
...
<div id="page">
 ...
 <div id="gallery-actions"></div>
		...
		<div class="gallery-content">
			<h1>Contact</h1>
<div class="col col_left"><div class="inner"><p>Photo Gallery Template<br />
Address:<br />
78901 Paris, France</p></div></div>
<div class="col col_right"><div class="inner"><p>E-Mail: <a href="mailto:contact@flash-gallery.net">contact@flash-gallery.net</a><br />
Phone: +00 (0)000 0000000<br />
VAT ID:  AADD0101</p></div></div><br class="clear" />
<h3>Services</h3>
...
<h2>Send me a message</h2>
		 <form id="contact-form" action="" method="post">
                ...
                <fieldset>
                    ...
                    <div class="field">
                        <label for="contact_reason">Contact</label>
                        <select id="contact_reason" name="contact_reason" required="required" title="Tell us how we can we help you">
                            <option></option>
  ...
  <div id="footer">
    <footer>
      <p class="copy">© <a href="http://flash-gallery.net" title="flash-gallery.net">Flash Gallery Net</a> &nbsp;|&nbsp; <a href="http://www.facebook.com/flashgallery.net" target="_blank">Follow me on Facebook</a></p>
      <div id="info">
      ...
      <div id="gallery-supplies">
        ...
        <div class="gallery-name"><span><strong>FGN</strong></span></div>
        <ul class="social">
          <li class="facebook"><a href="https://www.facebook.com/sharer/sharer.php?u=http://www.design17.flash-gallery.net/contact/index.php" target="_blank"><span>Facebook</span></a></li>
          <li class="twitter"><a href="https://twitter.com/home?status=design17.flash-gallery.net%20-%20" target="_blank"><span>Twitter</span></a></li>
          <li class="email"><a href="mailto:?body=contact@flash-gallery.net - &amp;subject=design17.flash-gallery.net"><span>Mail</span></a></li>
        </ul>
      </div>
